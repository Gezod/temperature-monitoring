        ...
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-2">
                ...
                <select name="validation_status" id="validation_status" class="form-select">
                    ...
                    <option value="imported" {{ request('validation_status') == 'imported' ? 'selected' : '' }}>Imported</option>
                    <option value="manual" {{ request('validation_status') == 'manual' ? 'selected' : '' }}>Manual</option>
                    <option value="edited" {{ request('validation_status') == 'edited' ? 'selected' : '' }}>Edited</option>
                </select>
            </div>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0"><i class="bi bi-calendar3"></i> {{ \Carbon\Carbon::parse($date)->format('d M Y') }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <small class="text-muted">Range: {{ number_format($minTemp, 1) }}°C - {{ number_format($maxTemp, 1) }}°C</small>
                            </div>
                            @if($pendingCount > 0)
                            ...
                            <div class="mt-3 d-flex justify-content-between">
                                <small class="text-muted">{{ $dateReadings->first()->reading_time }} - {{ $dateReadings->last()->reading_time }}</small>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="pdfUploadForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="machine_name" class="form-label">Nama Mesin <span class="text-danger">*</span></label>
                        <input type="text" name="machine_name" id="machine_name" class="form-control" required placeholder="Nama Mesin">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-success"><i class="bi bi-upload"></i> Upload & Validasi PDF</button>
                </form>
