        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="h5 text-{{ $anomaly->temperatureReading->status == 'critical' ? 'danger' : ($anomaly->temperatureReading->status == 'warning' ? 'warning' : 'success') }}">
                ...
                <div class="mt-3">
                    ...
                    <p>Acknowledged by <strong>{{ $anomaly->acknowledged_by }}</strong> on {{ $anomaly->acknowledged_at->format('d/m/Y H:i:s') }}</p>
                </div>
                @endif
            ...
            <div class="card-body">
                <table class="table table-sm table-borderless">
                    ...
                    <tr>
                        ...
                        <td>{{ $anomaly->machine->temp_min_normal }}°C to {{ $anomaly->machine->temp_max_normal }}°C</td>
                    </tr>
                    <tr>
                        <td><strong>Critical Range:</strong></td>
                        <td>{{ $anomaly->machine->temp_critical_min }}°C to {{ $anomaly->machine->temp_critical_max }}°C</td>
                    </tr>
                </table>
            </div>
        </div>
                ...
                <div class="border-bottom pb-2 mb-2">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small>{{ $similar->temperatureReading->temperature }}°C</small>
                        </div>
                    ...
                    <div class="mt-1">
                        <a href="{{ route('anomalies.show', $similar) }}" class="btn btn-sm btn-outline-primary">
                            View
                        </a>
                    </div>
                </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('temperature.show', $anomaly->temperatureReading) }}" class="btn btn-outline-info">
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBackgroundColor: relatedReadings.map(r =>
                    r.id === {{ $anomaly->temperature_reading_id }} ? '#ff6b6b' : '#4facfe'
                ),
